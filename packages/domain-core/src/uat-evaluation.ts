  ...
  return evaluateIntegratedDecision(
    {
      ...
      destinationFacts: {
        ...
        product_identity: cargoCategory,
        product_description: description,
        composition: request.compositionKnown === false ? "unknown" : "known",
        dangerous_goods_indicators:
          request.hazardIndicators?.length ? request.hazardIndicators : "none_declared",
        hazard_data:
          request.hazardIndicators?.length ? request.hazardIndicators : "none_declared",
        origin,
        ...
        movement_time: request.transactionDate,
        movement_date: request.transactionDate,
        planned_shipment_date: request.transactionDate,
      },
    },
